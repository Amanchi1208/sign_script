...
| 🟢️ | 签到 | WEB | 阿里云盘(多用户版)  | https://www.aliyundrive.com | aliyundrive_multiuser.js | 2024-04-11 | 是 | 是 | 签到、自动领取首个任务奖励 |
| 🟤 | 签到 | WEB | 百度贴吧 | https://tieba.baidu.com | tieba.js | 2024-04-11 | 是 | 是 | 签到、只能签6个左右 |
...
| 🟢️ | 签到 | 小程序 | WPS(稻壳版) | https://vip.wps.cn/ | wps_docker.js | 2024-04-11 | 是 | 是 | 适用于稻壳签到，自动领取和保存每日PPT |
| 🟢️ | 签到 | WEB | 网易云游戏 | https://cg.163.com/ | wangyiyungame.js | 2023-08-26 | 是 | 是 | 签到 |
| 🟢️ | 抽奖 | WEB | 什么值得买 | https://www.smzdm.com/ | smzdm.js | 2024-04-11 | 是 | 是 | 抽奖 |
| 🟢️ | 签到 | WEB | 在线工具 | https://tool.lu/ | toolu.js | 2024-04-11 | 是 | 是 | 签到获取积分 |
